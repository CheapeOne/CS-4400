...
cur.execute("INSERT into POI_Location VALUES (\"\", \"\", \"\", \"\", \"No\", \"\")")
cur.execute("INSERT into POI_Location VALUES (\"\", \"\", \"\", \"\", \"No\", \"\")")
cur.execute("INSERT into POI_Location VALUES (\"\", \"\", \"\", \"\", \"No\", \"\")")
cur.execute("INSERT into POI_Location VALUES (\"\", \"\", \"\", \"\", \"No\", \"\")")
cur.execute("INSERT into POI_Location VALUES (\"\", \"\", \"\", \"\", \"No\", \"\")")
...
cur.execute("INSERT into Data_Points VALUES (\"Georgia Tech\", \"01/31/2017 15:32\", \"12\", \"Mold\")")
cur.execute("INSERT into Data_Points VALUES (\"Georgia Tech\", \"02/15/201716:12\", \"42\", \"Mold\")")
cur.execute("INSERT into Data_Points VALUES (\"Georgia Tech\", \"02/24/2017 4:29\", \"4\", \"Air Quality\")")
cur.execute("INSERT into Data_Points VALUES (\"Georgia Tech\", \"02/01/2017 3:57\", \"34\", \"Air Quality\")")
